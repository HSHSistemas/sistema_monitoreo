...
$lote_tres = htmlspecialchars(strtoupper($_POST['lote_tres']),ENT_QUOTES,'UTF-8');
$lote_cuatro = htmlspecialchars(strtoupper($_POST['lote_cuatro']),ENT_QUOTES,'UTF-8');
...
{
    $consulta = $modelo_prterm->Registrar_Salida_Producto_Terminado_Cuatro_Lotes($id_producto,$lote,$lote_dos,$lote_tres,$lote_cuatro,$cantidad,$folio_venta);
    echo $consulta;
}